...
Run from project root:
    python src/8_ranking/scripts/step0_frequency_analysis.py

Output:
    data/processed/word_frequency_top500.csv
    data/processed/aspect_keyword_frequency.csv

After reviewing output: update ASPECT_KEYWORDS in src/8_ranking/absa.py,
...
import pandas as pd
from src.8_ranking.absa import frequency_analysis, ASPECT_KEYWORDS
...
print("\nStep 0 complete.")
print("Next: review output, update ASPECT_KEYWORDS in src/8_ranking/absa.py if needed,")
